...
export EXTRA_CFLAGS=${EXTRA_CFLAGS:="-fopenmp -fopenmp-assume-no-thread-state -fopenmp-targets=amdgcn-amd-amdhsa -Xopenmp-target=amdgcn-amd-amdhsa -march=gfx90a"}
